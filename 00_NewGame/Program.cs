...
Console.WriteLine("\nWe are all very pleased to see you here " + player.name + "! We Just want to remind you again when you took that online survey last week you were automatically signed up for the fight club today. Whether you read the fine print or not here you are, and here we are, are you ready to begin yes or no?\n");

string answer1 = Console.ReadLine();
switch (answer1)
{
    case "yes" :
    Console.WriteLine("\nWelcome to Marvin's Monday night punch out get ready for your briefing!");
    break;
    case "no" :
    Console.WriteLine("\nQuick take him out Peety he's seen too much!");
...
{
    Console.WriteLine("\nYou contracted mersa from the unclean underground environment lose 20 health points!");
